...
.back-home:hover { color: #f2ca59; border-color: rgba(242, 202, 89, 0.3); }
...
.market-visual { position: relative; height: 160px; margin-top: 28px; overflow: hidden; border-radius: 18px; border: 1px solid rgba(255,255,255,.06); background: linear-gradient(180deg, rgba(255,255,255,.025), rgba(255,255,255,.005)); }
...
.market-visual svg { position: absolute; inset: 18px 0 0; width: 100%; height: 130px; }
...
.c1 { left: 18%; top: 92px; height: 30px; }
.c2 { left: 43%; top: 62px; height: 38px; }
.c3 { left: 66%; top: 42px; height: 31px; }
.c4 { left: 82%; top: 30px; height: 44px; }

.trust-row { margin-top: auto; padding-top: 24px; display: flex; align-items: center; gap: 14px; color: #74777e; font-size: 10px; font-weight: 800; letter-spacing: .18em; }
.trust-row i { width: 3px; height: 3px; border-radius: 999px; background: #b88b24; }

.form-panel { display: flex; align-items: center; justify-content: center; background: #0d0f13; width: 100%; }
.form-wrap { width: min(410px, 100%); padding: 48px 36px; box-sizing: border-box; }
.mobile-logo { display: none; width: 220px; margin: 0 auto 32px; }
.form-heading h2 { font-family: Manrope, Inter, sans-serif; margin: 0; font-size: clamp(24px, 4vw, 32px); letter-spacing: -.035em; color: #faf9f6; }
.form-heading > p:last-child { color: #777b84; font-size: 14px; margin-top: 8px; }
.login-form { margin-top: 32px; display: grid; gap: 20px; }
.field { display: grid; gap: 8px; }
.field > span { color: #c4c5c7; font-size: 12px; font-weight: 700; }
.field input { width: 100%; height: 52px; box-sizing: border-box; border-radius: 12px; border: 1px solid #2a2c32; background: #14161b; color: #f6f6f4; padding: 0 15px; font-size: 15px; font-family: inherit; outline: none; transition: border-color .2s, box-shadow .2s, background .2s; }
...
.password-toggle { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); border: 0; background: transparent; color: #b89239; font-size: 11px; font-weight: 800; cursor: pointer; padding: 8px; }
.form-meta { display: flex; justify-content: space-between; gap: 14px; margin-top: -6px; color: #5e626b; font-size: 11px; }
...
.register-copy { color: #6e7179; text-align: center; font-size: 13px; margin-top: 24px; }
.register-copy a { color: #e0b648; font-weight: 800; text-decoration: none; margin-left: 4px; }
.register-copy a:hover { color: #f4d36d; }

@media (max-width: 900px) {
    .login-page { padding: 76px 16px 28px; background-attachment: scroll; }
    .login-shell { grid-template-columns: 1fr; min-height: auto; max-width: 520px; }
...
@media (max-width: 520px) {
    .login-page { padding: 68px 12px 24px; }
    .back-home { top: 18px; left: 14px; font-size: 12px; padding: 6px 12px; }
    .login-shell { border-radius: 20px; }
    .form-wrap { padding: 32px 18px 28px; }
    .mobile-logo { width: 190px; margin-bottom: 28px; }
    .field input { font-size: 16px; height: 48px; }
    .submit-btn { height: 48px; }
    .form-meta { flex-direction: column; gap: 6px; }
}
</style>
