...
@media (max-width: 620px) { .register-page { padding: 68px 14px 24px; }.back-home { left: 18px; top: 20px; }.register-card { padding: 30px 20px; border-radius: 20px; }.form-grid { grid-template-columns: 1fr; gap: 16px; }.register-header h1 { font-size: 28px; }.brand-wordmark { font-size: 31px; } }
</style>
