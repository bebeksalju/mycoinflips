                ...
                <table class="w-full text-left text-sm text-gray-400">
                    <thead class="bg-gray-900/50 text-xs uppercase font-bold text-gray-500">
                        <tr>
                            ...
                            <th v-if="authStore.user.role === 'SUPERUSER' || authStore.user.role === 'ADMIN'" class="px-6 py-4 text-center">Profit Mode (Rigged)</th>
                    ...
                    <tbody class="divide-y divide-gray-700/50">
                        ...
                        <tr v-for="user in authStore.users" :key="user.id"
                            ...
                            <td v-if="authStore.user.role === 'SUPERUSER' || authStore.user.role === 'ADMIN'" class="px-6 py-4 text-center">
